                    ...
                    <form action="{{ route('works.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="status"
                                ...
                                required>
                                <option value="">選択してください</option>
                                <option value="気になる" @selected(old('status')==='気になる' )>気になる</option>
                                <option value="進行中" @selected(old('status')==='進行中' )>進行中</option>
                        ...
                        <div>
                            ...
                            <div class="mt-4 p-4 bg-gray-50 border rounded-xl">
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    映画・ドラマ・アニメはTMDb、本・漫画はGoogle Booksで画像候補を検索できます。
                                </p>
